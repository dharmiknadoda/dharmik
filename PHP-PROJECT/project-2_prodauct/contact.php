                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-lg-6 col-12">
                            ...
                            <form class="contact-form me-lg-5 pe-lg-3"  method="POST">
                                ...
                                <div class="form-floating mb-4">
                                    <textarea id="message" name="comment" class="form-control" placeholder="Leave a comment here" required style="height: 160px"></textarea>
                        ...
                        <?php
                            ...
                            if(isset($_POST['submit']))
                            {
                                ...
                                $insert = "insert into contect(name,email,subject,comment) values('$name','$email','$subject','$comment')";
