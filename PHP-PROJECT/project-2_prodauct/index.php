                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-5 col-12">
                                            <div class="d-flex flex-column h-100 ms-lg-4 mt-lg-0 mt-5">
                                                ...
                                                <p>Little Fashion templates comes with <a href="sign-in.php">sign in</a> / <a href="sign-up.php">sign up</a> pages, product listing / product detail, about, Add product, and contact page.</p>
                    ...
                    <div class="row align-items-center">
                        ...
                        <div class="col-lg-6 col-12">
                            <div class="px-5 `py-5 py-lg-0">
                                ...
                                <p class="lead mb-4">“Be kind, for everyone you meet is fighting a battle you know nothing about.”</p>
