<?php 
    ...
    if(isset($_POST['submit']))
    {
        ...
        $insert = "insert into docter(name,email,dep_name,img) values('$name','$email','$dep_name','$img')";
        $query = mysqli_query($conn , $insert);
    }
    if(isset($_GET['delete']))
    {
      $id = $_GET['delete'];
      $query = "delete from docter where id = '$id'";
    ...
    if(isset($_POST['id']))
        {
            ...
            $update = "update docter set name='$name', email='$email' , dep_name='$dep_name' , img='$img' where id ='$id'";
    ...
    if(isset($_FILES['img']))
    {
        ...
        if(move_uploaded_file($tmp_name,"pic/".$file_name))
        {
            echo "file uploaded";
        }else
        {
                    ...
                    <?php 
                        ...
                        if($query)
                        {
                            ...
                            echo '<tr>
                                    ...
                                    <td>'.$email.'</td>
                                    <td>'.$dep_name.'</td>
                                    <td>'.'<button type="button" class="btn"><a href="docter.php?delete=' . $id . '">Delete</a></button>'.'</td>
                                    <td>'.'<button type="button" class="btn btnn"><a href="docter.php?id=' . $id . '">Update</a></button>'.'</td>
                                </tr>';
