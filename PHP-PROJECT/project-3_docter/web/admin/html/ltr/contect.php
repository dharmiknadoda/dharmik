<?php 
    ...
    {
      $id = $_GET['delete'];
      $query = "delete from contect where id = '$id'";
    ...
    if(isset($_GET['filter']) && isset($_GET['filter_btn'])) {
        ...
        $sql = "SELECT * FROM `contect` WHERE `name` LIKE '%$filtername%'";
        $query = mysqli_query($conn , $sql);
    }else
    {
        $select = 'select * from contect';
                    ...
                    <?php 
                        ...
                        if($query)
                        {
                            ...
                            echo '<tr>
                                    ...
                                    <td>'.$phone.'</td>
                                    <td>'.$massage.'</td>
                                    <td>'.'<button type="button" class="btn"><a href="contect.php?delete=' . $id . '">Delete</a></button>'.'</td>
                                </tr>';
