<?php 
    ...
    if(isset($_POST['submit']) && isset($_FILES['poster']))
    {
        ...
        // $post_name = $_FILES['poster']['name'];
        // $tmp_post = $_FILES['poster']['tmp_post'];
        // if(move_uploaded_file($tmp_post,"pic/".$post_name))
        // {
    ...
    if(isset($_GET['id']))
        {   
            $update = "update `cast` set movie_id='$movie_id' , movie_name='$movie_name' , actor='$actor' , role='$role' where id ='$id'";
            $query = mysqli_query($conn , $update);    
        }
        else{
            $insert = "insert into `cast`(movie_id,movie_name,actor,role,poster) values('$movie_id','$movie_name','$actor','$role','$poster')";
...
if(isset($_GET['filter']) && isset($_GET['filter_btn'])) {
    ...
    $sql = "SELECT * FROM `cast` WHERE `actor` LIKE '%$filtername%'";
    $query = mysqli_query($conn , $sql);
}else
{
    $select = 'select * from `cast`';
                    ...
                    <?php 
                        ...
                        if($query)
                        {
                            ...
                            echo '<tr>
                                    ...
                                    <td>'.$actor.'</td>
                                    <td>'.$role.'</td>
                                    <td>'.'<button type="button" class="btn"><a href="cast.php?delete=' . $id . '">Delete</a></button>'.'</td>
                                    <td>'.'<button type="button" class="btn btnn"><a href="cast.php?id=' . $id . '">Update</a></button>'.'</td>
                                </tr>';
