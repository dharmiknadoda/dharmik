<?php 
    ...
    if(isset($_GET['id']))
        {   
            $update = "update premieres set movie_name='$movie_name' , view='$view' , language='$language' , duration='$duration' , type='$type' , date='$date' , poster='$poster' , banner='$banner' where id ='$id'";
            $query = mysqli_query($conn , $update);    
        }
        else{
            $insert = "insert into premieres(movie_name,view,language,duration,type,date,poster,banner) values('$movie_name','$view','$language','$duration','$type','$date','$poster','$banner')";
            $query = mysqli_query($conn , $insert);
        }
        if($query)
        {
            header('location:premieres.php');
        }

    if(isset($_GET['delete']))
    {
      $id = $_GET['delete'];
      $query = "delete from premieres where id = '$id'";
...
<body>
    ...
    <h2 class="hhh">All Premieres Movie Data</h2>   
                    ...
                    <?php 
                        ...
                        if($query)
                        {
                            ...
                            echo '<tr>
                                    ...
                                    <td>'.$type.'</td>
                                    <td>'.$date.'</td>
                                    <td>'.'<button type="button" class="btn"><a href="premieres.php?delete=' . $id . '">Delete</a></button>'.'</td>
                                    <td>'.'<button type="button" class="btn btnn"><a href="premieres.php?id=' . $id . '">Update</a></button>'.'</td>
                                </tr>';
