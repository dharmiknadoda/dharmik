												...
												<div class="trend_2im1 clearfix">
													<div class="grid">
														<figure class="effect-jazz mb-0">
															<a href="plays_detail.php?id=<?php echo $id ?>"><img style="height: 378px;" src="pic/<?php echo $poster ?>" class="w-100" alt="img25"></a>
														</figure>
													</div>
												</div>
...
<div class="pag">
            <?php
                $total_row_query = "SELECT COUNT(*) as count FROM plays";
