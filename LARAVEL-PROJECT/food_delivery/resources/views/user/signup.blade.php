            ...
            <div class="container">
                <div class="for">
                    <div class="tit" style="height: 50px;"></div>
                        <h1 style="font-family: Segoe Script; text-align: center; color: #8ec038; margin-top: 20px;">Sign-Up</h1>
                    <!-- </div> -->
                    <form action="{{route('signup')}}" method="post" class="d-flex" style="flex-direction: column;">
                        @csrf
                        ...
                        <input type="date" name="date" placeholder="Date" class="mt-4">
                            <span class="text-danger fw-bold">
                                @error('date')
                                    {{$message}}
                                @enderror
